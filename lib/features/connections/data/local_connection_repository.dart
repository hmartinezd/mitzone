...
class LocalConnectionRepository implements ConnectionRepository {
  ...
  @override Future<ConnectionRequest?> getRelationship({required String userAId, required String userBId, required String encounterId}) async => _parseRequests((await _read())['requests']).where((r) => r.encounterId == encounterId && ((r.senderUserId == userAId && r.recipientUserId == userBId) || (r.senderUserId == userBId && r.recipientUserId == userAId))).firstOrNull;
  @override Future<ConnectionRequest> sendRequest({required String senderUserId, required String recipientUserId, required String encounterId, String? contextId}) async {
    ...
    final data = await _read(); final requests = _parseRequests(data['requests']);
