...
abstract interface class ConnectionRepository {
  Future<ConnectionRequest?> getRelationship({required String userAId, required String userBId, required String encounterId, String? contextId});
  Future<ConnectionRequest> sendRequest({required String senderUserId, required String recipientUserId, required String encounterId, String? contextId});
  ...
  Future<RelationshipState> getRelationshipState({required String userAId, required String userBId, String? contextId, String? encounterId});
}
