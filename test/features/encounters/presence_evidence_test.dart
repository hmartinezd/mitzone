...
void main() {
  test('presence evidence is bounded and UTC-aware', () {
    final evidence = PresenceEvidence(
      ...
      source: PresenceEvidenceSource.localDemo,
      confidence: 0.8,
    );
  ...
  test('encounters reject self-pairs and reversed intervals', () {
    expect(
      () => Encounter(
        ...
        otherUserId: 'a',
        eventId: 'event',
        overlapStart: DateTime.utc(2026),
        overlapEnd: DateTime.utc(2026),
      ),
    ...
    expect(
      () => PresenceEvidence(
        ...
        subjectUserId: 'a',
        contextId: 'event',
        observedStart: DateTime.utc(2026, 1, 2),
        observedEnd: DateTime.utc(2026, 1, 1),
        source: PresenceEvidenceSource.localDemo,
      ),
      throwsA(isA<DomainError>()),
    );
