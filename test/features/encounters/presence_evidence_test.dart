...
void main() {
  ...
  test('encounters reject self-pairs and reversed intervals', () {
    expect(() => Encounter(id: 'e', currentUserId: 'a', otherUserId: 'a', eventId: 'event', overlapStart: DateTime.utc(2026), overlapEnd: DateTime.utc(2026)), throwsA(isA<AssertionError>()));
    expect(() => PresenceEvidence(id: 'e', subjectUserId: 'a', contextId: 'event', observedStart: DateTime.utc(2026, 1, 2), observedEnd: DateTime.utc(2026, 1, 1), source: PresenceEvidenceSource.localDemo), throwsA(isA<AssertionError>()));
  });
}
