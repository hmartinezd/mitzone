...
void main() {
  ...
  testWidgets('discovery searches title and venue and filters joined events', (
    tester,
  ) async {
    final repo = TestParticipationRepository()
  ...
  testWidgets(
    'joined participation loading is not shown as false empty state',
    (tester) async {
